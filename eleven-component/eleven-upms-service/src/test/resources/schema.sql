...
create index idx_gate_route_delete_at
...
create index upms_access_token_principal_name_principal_type_index
...
create index idx_upms_authority_02
...
create index idx_upms_user_delete_at
    on upms_user (delete_at);

create index idx_upms_user_deleted_at
    on upms_user (delete_at);
