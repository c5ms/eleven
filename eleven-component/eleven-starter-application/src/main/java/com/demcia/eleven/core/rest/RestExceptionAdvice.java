...
import com.demcia.eleven.core.exception.*;
...
public class RestExceptionAdvice {
    ...
    public RestFailure onProcessFailureException(ProcessFailureException e) {
        return new RestFailure()
    ...
    public RestFailure onProcessErrorException(ProcessErrorException e) {
        log.error("服务器错误",e);
        return new RestFailure()
                .setMessage(StringUtils.defaultIfBlank(e.getMessage(), "服务器错误"))
                .setError(StringUtils.defaultIfBlank(e.getError(), "Errored"));
    }
