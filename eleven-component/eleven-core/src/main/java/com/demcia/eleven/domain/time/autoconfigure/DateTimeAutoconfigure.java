package com.demcia.eleven.domain.time.autoconfigure;

import com.demcia.eleven.domain.time.DefaultTimeService;
import com.demcia.eleven.domain.time.DynamicAdjustableClock;
import com.demcia.eleven.domain.time.TimeService;
import com.demcia.eleven.domain.time.TimestampProvider;
import com.demcia.eleven.domain.time.provider.DataBaseTimestampProvider;
import com.demcia.eleven.domain.time.provider.LocalTimestampProvider;
