...
public class SecurityConfigure {
    ...
    public static class Local {
        ...
        @Bean
        @ConditionalOnBean(UserManager.class)
        LocalUserPrincipalAuthenticatorProvider userPrincipalAuthenticatorProvider(UserManager userManager) {
            return new LocalUserPrincipalAuthenticatorProvider(userManager);
        }
