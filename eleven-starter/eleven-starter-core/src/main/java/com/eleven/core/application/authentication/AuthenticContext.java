...
import com.eleven.core.application.authentication.support.ElevenAuthentication;
...
public class AuthenticContext {
    ...
    public static Principal requirePrincipal() {
        return getPrincipal().orElseThrow(() -> new AccessDeniedException("unauthorized"));
    }
